...
const OrganizationProfile = () => {
    ...
    let photoProfileName =localStorage.getItem("pPhotoName")
    let photoProfileUserName =localStorage.getItem("pPhotoUserName")
    let photoProfileType =localStorage.getItem("pPhotoType")
    let photoProfilePrice = localStorage.getItem("pPrice")
    ...
    return (
        <>
                            ...
                            <div className="col-lg-6">
                                <div className="orgProfile_box">
                                    <div className="section1 d-flex mb-3">
                                        <h2 className='pe-3'>{photoProfileUserName}</h2>
                                        <button className='btn btn-primary ms-3' onClick={()=>setBookStatus(true)}>Book Schedule</button>
                                        <span className='ms-3 mt-3' style={{fontSize:"18px",fontWeight:"700"}}>&#8377;{photoProfilePrice}/day</span>
                                    </div>
            ...
            <i className='fas fa-arrow-alt-circle-left fa-2x' style={{marginLeft: "8rem"}}></i>
                <Link to='/photographer' target="_self" style={{marginTop:"-28px",display: "block",marginLeft: "11rem"}}> Previous Page</Link>
            </div>
           ...
           <div className="orgPhoto_section mt-5">
                <div className="container">
                    <div className="row">
